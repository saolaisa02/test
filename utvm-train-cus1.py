...
def create_model_custom1():
    print("Model cus1 mish\n --------------------------------------------------------")
    input_layer = Input(shape=(None,None,3),name='input')

    x = conv_batch(input_layer, 16, 5, strides=(2, 2))
...
if __name__ == '__main__':
    main()
''' 
python utvm-train-cus1.py --model models_official/utvm_models_cus1_private_data/utvm-model-private-data-cus1_backup_max --name utvm-model-private-data-cus1 --output-dir models_official/utvm_models_cus1_private_data -op Adam -lr .0001 -its 100000 -bs 32
