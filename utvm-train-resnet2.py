...
def res_block_down(x,sz,filter_sz=3):
    xi  = Mish()(x)
...
def create_model_resnet2():
    print("Model cus resnet2\n--------------------------------------------------------")
    ...
    x = Conv2D(256, 1, activation='linear', padding='same', strides=(1,1), bias=False)(x) 
...
#             test_data = read_data("/data/anhnt/utvm_data_split/new_1008/bienso_test_T10_clear.txt")
            ...
            train_data = read_data("/data/anhnt2/utvm_data_split/all_data/bienso_alldata_train.txt")
            test_data = read_data("/data/anhnt2/utvm_data_split/all_data/bienso_alldata_test.txt")
...
if __name__ == '__main__':
    main()
''' 
python utvm-train-resnet2.py --name utvm-model-stanford-resnet2-new --output-dir models_official/utvm_stanford_models_resnet2_new -op Adam -lr .0001 -its 100000 -bs 32

python utvm-train-resnet2.py --model models_official/utvm_models_resnet2/utvm-model-privatedata-resnet2_backup_max --name utvm-model-privatedata-resnet2 --output-dir models_official/utvm_models_resnet2 -op Adam -lr .0001 -its 100000 -bs 32

python utvm-train-resnet2.py --model final_models/utvm-alldata/utvm_models_resnet2_privatedata/utvm-model-privatedata-resnet2_backup_max --name utvm-model-privatedata-resnet2 --output-dir final_models/utvm-alldata/utvm_models_resnet2_privatedata -op Adam -lr .0001 -its 100000 -bs 32
