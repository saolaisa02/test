...
if __name__ == '__main__':
    main()
''' 
python utvm-train-resnet-cus.py --model models_official/utvm_models_resnet_cus/utvm-model-stanford-resnet-cus_backup_max --name utvm-model-stanford-resnet-cus --output-dir models_official/utvm_models_resnet_cus -op Adam -lr .0001 -its 100000 -bs 32

python utvm-train-resnet-cus.py --model models_official/utvm_models_privatedata_resnet_cus/utvm-model-privatedata-resnet-cus_backup_max --name utvm-model-privatedata-resnet-cus --output-dir models_official/utvm_models_privatedata_resnet_cus -op Adam -lr .0001 -its 100000 -bs 32
